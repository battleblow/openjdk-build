...
export REPO="$WORKSPACE/repo/jdk7u"
export PATCHES="$SCRIPT_DIR/patches/"
export UPSTREAM=https://github.com/battleblow/jdk7u.git
...
export MODULES=(corba langtools jaxp jaxws jdk hotspot)
export MODULES_WITH_ROOT=(root corba langtools jaxp jaxws jdk hotspot)
